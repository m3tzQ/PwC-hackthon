...
class ReplacementDecision(models.Model):
    injured_player = models.ForeignKey(
        Player,
        related_name="replacement_decisions_as_injured",
        on_delete=models.CASCADE,
    )
    replacement_player = models.ForeignKey(
        Player,
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(fields=["injured_player", "is_active"]),
        ]